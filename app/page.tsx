...
function GridItem({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <motion.div
      ...
      className={`break-inside-avoid rounded-2xl overflow-hidden relative group cursor-pointer ${className || ""}`}
    >
      {children}
    </motion.div>
  );
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-zinc-800">
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-[1800px] mx-auto">
        ...
        <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-4 space-y-4">
          ...
          <GridItem className="bg-[#f4f4f0] text-black p-8 h-[400px] flex flex-col justify-between">
             <div>
          ...
          {/* Item 3: Bold Color */}
          <GridItem className="bg-[#ff4d00] text-white p-8 h-[350px] flex flex-col justify-between">
             <div>
          ...
          <GridItem className="bg-[#0055ff] text-white p-8 h-[450px] flex flex-col justify-between">
          ...
          {/* Item 7: Dark UI Card */}
          <GridItem className="bg-[#111] border border-white/10 text-white p-8 h-[550px] flex flex-col hover:border-white/20 transition-colors">
          ...
          <GridItem className="bg-[#e5ff00] text-black p-8 h-[350px] flex flex-col justify-center items-center text-center">
          ...
          {/* Item 11: Tech UI */}
          <GridItem className="bg-[#0a0f0d] border border-white/10 text-white p-8 h-[450px] flex flex-col hover:border-white/20 transition-colors">
          ...
          <GridItem className="bg-[#111] text-white p-8 h-[400px] flex flex-col items-center justify-center text-center">
          ...
          <GridItem className="bg-[#fcfcfc] text-black p-8 h-[350px] flex flex-col">
          ...
          <GridItem className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white p-8 h-[400px] flex flex-col justify-between">
          ...
          <GridItem className="bg-[#1a1a1a] border border-white/10 text-white p-8 h-[500px] flex flex-col hover:border-white/20 transition-colors">
          ...
          {/* Item 19: Quote */}
          <GridItem className="bg-[#f4f4f0] text-black p-10 h-[350px] flex flex-col justify-center">
